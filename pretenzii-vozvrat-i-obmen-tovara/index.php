...
$APPLICATION->SetTitle("Претензии, возврат и обмен товара");
?>
    <div class="wrap-lg returnsPage">
    <div class="returnsPage__title">
        <h1 class="single-title">Претензии, возврат и обмен товара</h1>
    </div>
    ...
    <div class="returnsPage__form">
        ...
        <form action="" class="returnsPage__form__wrapper">
            ...
            <div class="returnsPage__form__input returnsPage__form__input--half">
                <label for="attachment">Загрузить файл</label>
                <div class="inputFile">
                    <input type="file" name="attachment" value="">
                    <div class="inputFile__button">ЗАГРУЗИТЬ</div>
                </div>
            </div>
            <div class="returnsPage__form__input returnsPage__form__input--half">
            ...
            <div class="returnsPage__form__input returnsPage__form__input--full">
                ...
                <textarea name="message" placeholder="Введите текст письма, не более 500 знаков"></textarea>
            </div>
            <div class="returnsPage__form__input returnsPage__form__input--full">
